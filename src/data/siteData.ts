...
export const extensions = {
    ja: [
        {
            ...
            desc: "配信設定とX告知を1か所で管理。v1.1.0では、配信ごとのコメント自動投稿・任意の固定にも対応。",
    ...
    en: [
        {
            title: "Twitch Stream Helper",
            desc: "Manage stream settings and X announcements together. v1.1.0 adds one saved chat comment per stream with optional pinning.",
            ...
            features: [
                ...
                "Automatic chat posting and optional pins (v1.1.0)",
            ],
            isFree: true,
            badge: "v1.1.0",
